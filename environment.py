...
class SimpleGridworld(gym.Env):
    ...
    def __init__(self, size=15, n_obstacles=12, render_mode='human', add_door_key=True):
        ...
        self._charging_pad_location_2 = None # Will be set in reset()
        ...
        self.observation_space = gym.spaces.Dict({
            ...
            "charging_pad_loc_2": gym.spaces.Box(0, size - 1, shape=(2,), dtype=int),
    ...
    def _get_obs(self):
        ...
        return {
            ...
            "charging_pad_loc_2": self._charging_pad_location_2,
    ...
    def reset(self, seed=None, options=None):
        ...
        # Define the location for the second charging pad, on the other side of the wall
        self._charging_pad_location_2 = np.array([self.size - 2, self.size - 2])
        
        occupied_locations = {tuple(self._charging_pad_location), tuple(self._charging_pad_location_2)}
    ...
    def step(self, action):
        ...
        self.agent_energy = max(0.0, self.agent_energy - 0.25) # AGENT IS NOW MORE ENERGY EFFICIENT
        ...
        if np.array_equal(self._agent_location, self._charging_pad_location) or \
           np.array_equal(self._agent_location, self._charging_pad_location_2):
    ...
    def _render_frame(self):
        ...
        pygame.draw.rect(canvas, (200, 255, 200), pygame.Rect(self._charging_pad_location_2[1]*pix_square_size, self._charging_pad_location_2[0]*pix_square_size, pix_square_size, pix_square_size))
